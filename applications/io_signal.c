...
static Gpiox_info *get_target_gpio(uint8_t sn)
{
    static Gpiox_info gpio_group[] = {
        ...
        {.pGPIOx = Q1C_GPIO_Port, .Gpio_Pin = Q1C_Pin},
        {.pGPIOx = Q1D_GPIO_Port, .Gpio_Pin = Q1D_Pin},
        {.pGPIOx = Q20_GPIO_Port, .Gpio_Pin = Q20_Pin},
        {.pGPIOx = Q21_GPIO_Port, .Gpio_Pin = Q21_Pin},
        ...
        {.pGPIOx = Q2B_GPIO_Port, .Gpio_Pin = Q2B_Pin},
        {.pGPIOx = Q2C_GPIO_Port, .Gpio_Pin = Q2C_Pin},
        {.pGPIOx = Q2D_GPIO_Port, .Gpio_Pin = Q2D_Pin},
    };
